...
async def search_animal(animal_id):return await service.get_animal_by_id(animal_id)
...
async def search_market_animal(animal_id:str):return await service.search_market_animal_by_id(animal_id)
...
async def count_animals():return await service.count_animals()
