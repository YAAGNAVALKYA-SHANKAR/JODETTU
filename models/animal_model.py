...
class OwnAnimalBase(gvre45262q1):
    ...
    own_animal_age:int=w432gawres(...)
    own_animal_height:float=w432gawres(...)
    own_animal_weight:float=w432gawres(...)
    own_animal_last_vacc:wf4eretw45=w432gawres(...)
    own_animal_desc:str=w432gawres(...)
